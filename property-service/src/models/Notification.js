...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['property_approved', 'property_rejected', 'room_approved', 'room_rejected', 'booking_request', 'booking_approved', 'booking_rejected', 'payment_received', 'maintenance_request', 'general'],
    default: 'general'
  },
  related_property_id: {
